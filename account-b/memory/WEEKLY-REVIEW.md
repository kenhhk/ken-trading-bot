# Account B — Weekly Review Log

Strategy: AI Nowcasting (top-20 of top-100, daily rebalance, value-weighted)
Trial period: 60 trading days from first scoring run
Source: Chen & Pu (2026), arXiv:2601.11958

## Format
Each week appended below. Template:
...
- Equity end: $X
- Week return: ±X% ($±X)
- S&P 500 (SPY): ±X% | Alpha: ±X%
- Russell 1000 (IWB): ±X% | Alpha: ±X%
- Sharpe-to-date (annualized): X.XX
- Rebalances executed: N (of 5)
- Avg daily turnover: X% (X names swapped)
- Top 5 holdings by weight: TICKER (X%), ...
- Names that persisted all 5 days: TICKER, ...
- Notable in/out: TICKER in, TICKER out
- Pipeline failures: N (description)
- Grade: A-F
- Notes:
```
...
- Equity start: $24,235.85
- Equity end: $24,520.75
- Week return: +1.18% ($+284.90)
- SPY: n/a
- IWB: n/a
- Phase return: -1.92%
- Sharpe-to-date (ann.): 1.15
...
- Equity start: $23,113.04
- Equity end: $22,391.42
- Week return: -3.12% ($-721.62)
- SPY: n/a
- IWB: n/a
- Phase return: -10.43%
- Sharpe-to-date (ann.): -22.43
...
- Equity start: $23,409.49
- Equity end: $23,830.00
- Week return: +1.80% ($+420.51)
- SPY: n/a
- IWB: n/a
- Phase return: -4.68%
- Sharpe-to-date (ann.): 17.42
- Avg daily turnover (last 5 sessions): 58%
- Top 5 holdings: CRWD (5.5%), NOW (5.5%), MSTR (5.3%), WDAY (5.2%), ANET (4.9%)
- Grade: ?